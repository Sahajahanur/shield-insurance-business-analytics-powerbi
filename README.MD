...
<p align="center"> <img src="assets/shield\_insurance\_logo.png" width="100" alt="Shield Insurance logo"> </p> <h1 align="center">Shield Insurance Business Analytics</h1> <h3 align="center">Power BI Dashboard \& Stakeholder Presentation</h3> <p align="center"> <a href="https://youtu.be/7iQ8janiMzI">🎥 Video Walkthrough</a> • <a href="#dashboard-preview">📊 Dashboard Preview</a> • <a href="PROJECT\_REPORT.pdf">📄 Full Project Report</a> </p>
...
<p align="center"> <img src="assets/final\_general\_view.png" width="800" alt="Shield Insurance General View dashboard"> <br> <em>General View — Key Metrics, Trend, City \& Age breakdowns</em> </p> <p align="center"> <img src="assets/final\_sales\_mode.png" width="800" alt="Shield Insurance Sales Mode Analysis dashboard"> <br> <em>Sales Mode Analysis — Channel split and monthly trend</em> </p> <p align="center"> <img src="assets/final\_age\_group.png" width="800" alt="Shield Insurance Age Group Analysis dashboard"> <br> <em>Age Group Analysis — Customer behavior, settlement, and policy preference</em> </p>
...
📄 Full technical write-up: PROJECT\_REPORT.pdf
...
policy\_id is used instead of named policy categories in the Policy Preference visual because the source data does not contain a policy-type/category column.

Settlement data (fact\_settlements) has no date dimension, so settlement trends over time cannot be analyzed; only a static, age-level view is available.

Future Work

Map policy\_id to named policy categories, subject to client input.
